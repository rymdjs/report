...
In section~\ref{sec:modules}, \nameref{sec:modules}, the overall areas of responsibility for the system modules were defined. This resulted in the following concrete modules described in this chapter:
