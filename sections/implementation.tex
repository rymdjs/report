...
The signing uses $RSASSA-PKCS1-v1_5$. This choice is motivated by the lack of alternatives and the fact the the WebCrypto API recommends the use of this algorithm on their web page. Finally, there are no other RSA signing algorithms included in the WebCrypto API.
...
Regarding accessibility, both algorithms are included in the WebCrypto API and are therefore provided by the browser as black boxes.
