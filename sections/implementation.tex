...
$RSAES-PKCS1-v1.5$ - an AES implementation based on the RSA algorithm. The fact that it uses RSA is inline with our guidelines since it allows the key to be reused for both signing and encryption.
