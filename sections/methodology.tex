...
As stated in section~\ref{sec:purpose}, developers should be able to easily incorporate their own preferred implementations of the system's core functionality. For modularity to be properly fulfilled, these main features had to be clearly identified and separated into individual code repositories ("modules").
