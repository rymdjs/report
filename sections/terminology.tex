...
\begin{description}
  ...
  \item[SPKI] Simple public key infrastructure, SPKI is a successor to X.509: It was designed with the goal to eliminate overcomplication and scalability problems.
