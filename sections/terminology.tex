...
\begin{description}
  ...
  \item[X.509] a standard for a public key infrastructure (PKI) from the International Telecommunication Union Telecommunication Standardization Sector.
  \item[XSS] Cross Site Scripting: The technique of injecting client-side scripts into web pages as an attack method.
