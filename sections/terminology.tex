...
\begin{description}
  ...
  \item[Cryptocurrency] A network transaction system that uses a fully distributed cryptographically secured ledger (called \emph{blockchain}) to track transactions. The vast majority of cryptocurrencies are forks off Bitcoin.
  ...
  \item[PKCS\#8] Private-Key Information Syntax Standard, SPKI is a successor to X.509: It was designed with the goal to eliminate overcomplication and scalability problems.
  ...
  \item[SPKI] Simple public key infrastructure, does provide a way to construct private key certificates in ASN1.
