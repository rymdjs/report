...
\begin{description}
  ...
  \item [Peer-to-peer communication] Responsible for setting up initial contact with another peer and maintaining this connection. It also deals with securing this connection through end-to-end encryption.
...
\begin{description}
  \item [Resource storage] Deals with persisting data on disk and also provides means of accessing and manipulating the data.
  \item [Key storage]
