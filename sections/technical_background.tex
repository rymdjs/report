...
\section{WebRTC}
WebRTC is a project which enables real-time communication in the browser. Through the project developers are able to create different types of applications which leverage peer-to-peer technology. The functionality is abstracted into three different APIs: MediaStream, RTCPeerConnection and RTCDataChannel.
