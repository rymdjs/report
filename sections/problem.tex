\section{Problem}
There are several sub-problems in as system of this nature that the project needs to address. Below, the main points affecting the architecture are presented.
